...
# paste0(path, "openproblems_bmmc_multiome_phase2.manual_formatting.output_mod2_", batch, ".h5seurat"), assay="ATAC")
   Convert(paste0(path, "openproblems_bmmc_multiome_phase2.manual_formatting.output_mod2_lean_", batch, "_counts.h5ad"), 
paste0(path, "openproblems_bmmc_multiome_phase2.manual_formatting.output_mod2_", batch, "_counts.h5seurat"), assay="ATAC")
}
