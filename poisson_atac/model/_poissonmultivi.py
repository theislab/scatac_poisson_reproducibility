...
from poisson_atac.module import MULTIVAE
...
class MULTIVI(VAEMixin, UnsupervisedTrainingMixin, BaseModelClass):
    ...
    * The main batch annotation, specified in ``setup_anndata``, should correspond to
    ...
    #TODO: add peak likelihood option
    def __init__(
        self,
        adata: AnnData,
        n_genes: int,
        ...
        **model_kwargs,
        ...
        self._model_summary_string = (
            ...
            "gene_likelihood: {}, peak_likelihood: {}"
        ).format(
            n_genes,
            n_regions,
    ...
    #TODO: How to get region factors in poisson case?
    @torch.no_grad()
    ...
    #TODO: Adapt for different peak likelihood
    @torch.no_grad()
    ...
    #TODO: Add not implemented error for peak_likelihood
    @_doc_params(doc_differential_expression=doc_differential_expression)
