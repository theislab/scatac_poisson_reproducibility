...
from scale.dataset import load_dataset, concat_data, SingleCellDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--preprocessed', action='store_true', help='Data is already processed')
    ...
    if args.preprocessed:
        ...
        adata = concat_data(args.data_list, batch_categories=None, join='inner', batch_key='batch')
